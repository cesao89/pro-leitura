...
/**
 * Class ProjetoCategorias
 *
 * @author Cesar O Domingos <cesar_web@live.com>
 */
class Application_Model_ProjetoCategorias extends Application_Model_BaseDum
{
    public $db;
    public $fields = null;                                          // propriedades
    protected $classname = 'Application_Model_ProjetoCategorias';   // nome da classe
    protected $table = 'projeto_categorias';                        // tabela
    ...
    /**
     * Application_Model_ProjetoCategorias constructor.
     * @param null $id
     */
