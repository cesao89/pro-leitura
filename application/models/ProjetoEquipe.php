 ...
 */
class Application_Model_ProjetoEquipe extends Application_Model_BaseDum
{
    public $db;
    public $fields = null;                                      // propriedades
    protected $classname = 'Application_Model_ProjetoEquipe';   // nome da classe
    protected $table = 'projeto_equipe';                        // tabela
    ...
    /**
     * Application_Model_ProjetoEquipe constructor.
     * @param null $id
     */
